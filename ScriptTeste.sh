...
gcc src/*.c -o rede
mkdir -p saidas/saida
printf "\033[93mStartint script\033[0m\n"
time ./rede entradas/entrada/N10_S3_C3_M3.txt >saidas/saida/1.txt
echo "time ./rede entrada/N10_S3_C3_M3.txt >saida/1.txt"
time ./rede entradas/entrada/N100_S20_C30_M5.txt >saidas/saida/2.txt
echo "time ./rede entrada/N100_S20_C30_M5.txt >saida/2.txt"
time ./rede entradas/entrada/N1000_S50_C300_M10.txt >saidas/saida/3.txt
echo "time ./rede entrada/N1000_S50_C300_M10.txt >saida/3.txt"
time ./rede entradas/entrada/N10000_S50_C300_M10.txt >saidas/saida/4.txt
